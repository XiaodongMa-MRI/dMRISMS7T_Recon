...
if nargin < 4
    figure, imagesc(show_res, disp_range), set(gca,'Position',[0 0 1 1]), axis image off, colormap gray
%     figure, imagesc(show_res, disp_range), axis image off, colormap gray

else
    figure(fig_num), imagesc(show_res, disp_range), set(gca,'Position',[0 0 1 1]), axis image off, colormap gray
